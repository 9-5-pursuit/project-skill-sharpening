...
function createArrayWithTwoElements(a, b) {
  ...
  let arrWithTwoElements = [];
  arrWithTwoElements.push(a);
  arrWithTwoElements.push(b);
  return arrWithTwoElements;
}
...
function addElementToEndOfArray(array, element) {
  ...
  let addedElementToEndOfArray = array.push(element);
  return array;
}
...
function addElementToFrontOfArray(array, element) {
  ...
  let elementToFrontOfArray = array.unshift(element);
  return array;
}
