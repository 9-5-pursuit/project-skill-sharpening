...
function createArrayWithTwoElements(a, b) {
  // Create an array from two string into the array bracket
  let array = [a, b];
  return array;
}
...
function getArrayLength(array) {
  ...
  // The length of an array starts with 1 instead of 0 from an element of an array
  return array.length;
}
...
function getFirstElementOfArray(array) {
  // Look for the first element of an array
  // The element of an array starts with 0 instead of 1.
  return array[0];
}
...
function getLastElementOfArray(array) {
  // Look for the last element of an array
