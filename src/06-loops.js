...
function lastIndexFound(array, target) {
  ...
  for (let i = array.length - 1; i >= 0; i--) {
    ...
    // let length = matchedArray[length];
      ...
      if (matchedArray[matchedArray.length -1] >= 0) {
          console.log(matchedArray[matchedArray.length -1]);
          return matchedArray[matchedArray.length -1];
      }
  }
}
