...
function aroundTheWorldGreeting(language) {
  return language=='spanish' ? "Hola Mundo" : language=='english' ? "Hello World" : language=='german'
...
function calculateLetterGrade(grade) {
  return grade>=90 ? "A" : grade<60 ? "F" : grade<90 && grade>=80 ? "B" : grade<80 && grade>=70 ? "C" : "D"
}
...
function animalCounts(animal, numberOfAnimals) {
  return numberOfAnimals>1 ? `${numberOfAnimals} ${animal}s` : `1 ${animal}`
}
