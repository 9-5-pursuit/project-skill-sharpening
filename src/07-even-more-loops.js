...
//Can also use Math.min() and spread operators to solve this
...
//Can also use Math.max() and spread operators to solve this
...
//Can also use Array.prototype.includes() method to solve this
//function findEqual(array, selected) {
...
//You can also use Set data structure to solve this problem
//It will create a new Set from the array and spread it into an array again while removing all the duplicates.
