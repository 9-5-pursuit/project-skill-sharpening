...
function getFirstName(person) {
  // check if the person's name property exists
  if (person.names && person.names.first) {
    // if so, just return the first name property
    return person.names.first;
  } else if (person.name) {
    // if not, split the name string into an array
    let nameArr = person.name.split(" ");
    // then assign the first element in the array to the variable firstName
...
function getLastName(person) {
  // check if the person's name property exists
  if (person.names && person.names.last) {
    // if so, return the last name property
    return person.names.last;
  } else if (person.name) {
    // if not, split the name string into an array
    let nameArr = person.name.split(" ");
    // assign the last element in the array to the variable lastName
...
function getFullName(person) {
  return (
    person.names.first + " " + person.names.middle + " " + person.names.last
  );
}
