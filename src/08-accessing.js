...
const { lastIndexFound } = require("./06-loops");
...
function getFullAddress(person) {
 //Notes: Correct answer below:
  ...
  let {street, unit, city, state, zip} = person.address; // Destructuring
...
function getFlatObject(person) {
  return {...person.names, ...person.address, numbers: person.number}
}
