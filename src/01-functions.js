...
function average(a, b) {
  // add the two numbers
  // divide by the even number that were added together
  return (a + b) / 2;
}
...
function averageThree(a, b, c) {
  ...
  // divide by the odd numbers that were added together
  return (a + b + c) / 3;
}
