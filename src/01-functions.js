...
function getFirstAndLastCharacter(a) {
  ...
  let  getFirstAndLastCharacter = 0

  let firstCharacter = a[0];

  let lastCharacter = a[a.length-1];
 
  getFirstAndLastCharacter = firstCharacter + lastCharacter

  return getFirstAndLastCharacter;
}
